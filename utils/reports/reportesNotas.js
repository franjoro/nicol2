...
Excel.getConsolidadoBimestralExcel = (datos, roleBimestre, nombreGrado) => {
    return new Promise(async function(Resolve) {
        ...
        try {
            ...
            console.log(arrContadorReprobadosMasculino);
            console.log(arrContadorReprobadosFemenino);
            ws.cell(filaFinal + 5, 2).string("Cantidad materias aprobadas").style(styleTitles);
            ...
            ws.cell(filaFinal + 6, 2).string("Cantidad materias aplazadas").style(styleTitles);
